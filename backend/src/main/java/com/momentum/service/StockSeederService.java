...
public class StockSeederService {
    ...
    public void seedStocks() {
        List<Stock> stocksToSeed = List.of(
                ...
                new Stock(null, "TMO", "Thermo Fisher Scientific Inc.", "S&P 500"),
                new Stock(null, "COST", "Costco Wholesale Corporation", "S&P 500"),
                new Stock(null, "WMT", "Walmart Inc.", "S&P 500"),
                new Stock(null, "DIS", "The Walt Disney Company", "S&P 500"),
                new Stock(null, "NFLX", "Netflix, Inc.", "S&P 500"),
                ...
                new Stock(null, "AXON", "Axon Enterprise, Inc.", "S&P 400"),
                new Stock(null, "MANH", "Manhattan Associates, Inc.", "S&P 400"),
